...
<?php foreach ($model as $index => $item) : ?>
    ...
    <div class="row">
        <div class="col-md-3">
            <?= $form->field($item, "[$index]customer_id")->dropDownList(
                \yii\helpers\ArrayHelper::map(\app\models\Customer::find()->orderBy(['created_at' => SORT_DESC])->all(), 'id', 'name'),
                ['prompt' => 'Select the customer name']
            ) ?>            </div>
        <div class="col-md-3">
            <?= $form->field($item, "[$index]document_type")->dropDownList([
    ...
    <div class="row">
<!--        <div class="col-md-4">-->
<!--            --><?php //= $form->field($item, "[$index]product_id")->dropDownList(
...
<!--        <div class="col-md-4">-->
<!--            --><?php //= $form->field($item, "[$index]price")->textInput(['maxlength' => true]) ?>
<!--        </div>-->
    </div>
